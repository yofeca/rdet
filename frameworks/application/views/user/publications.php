                ...
                <?php for($i = 0; $i < count($items->rows); $i++){?>
                    <tr>
                        <?php for($j = 1; $j < count($items->rows[$i]['cell']); $j++){ ?>
                            <?php if($j == 1){ ?>
                                <td><a href="<?php echo base_url('user/preview_research/0/'.$items->rows[$i]['id']); ?>"><?php echo $items->rows[$i]['cell'][1] ?></a></td>
                            <?php continue; } ?>
                ...
                <?php } ?>
                    <tr><td colspan="9" style="text-align: center;">
                        ...
                        <?php for($k = 1; $k < $items->total+1; $k++){?>
                                <li><a href="<?php echo base_url('user/publications/?page='.$k); ?>"><?php echo "Page ". $k; ?></a></li>
                        <?php } ?>
                            </ul>
                    </td></tr>
            </table>
